function getEbookName() {
    ...
    let ebookList = document.createElement('div')
    ebookList.id = 'ebookList'

    document.getElementById('ebookList').innerHTML = document.getElementById('ebookList') ? '' : document.getElementById('divTextArea').appendChild(ebookList)
...
function buttonTopo() {
    ...
    let verificar = document.getElementById('searchBar')
    /* Selecionamos o botão */
    let button = document.getElementById('back-to-top')

    if (verificar.getBoundingClientRect().y <= 0) {
